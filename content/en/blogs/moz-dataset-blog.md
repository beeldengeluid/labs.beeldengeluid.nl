...
of the MOZ concerts have a standardised location at program level. As we have not been able to map all program locations, the picture is still not complete. However, we can already give a better
